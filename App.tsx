...
const App: React.FC = () => {
  ...
  const saveReport = (query: string, mode: AnalysisMode, content: string) => {
    const newReport: SavedReport = {
      ...
      title: query || (lang === 'en' ? 'Global Market Update' : '글로벌 시장 업데이트'),
      query,
      mode,
          ...
          <div className={`w-full max-w-3xl transition-all duration-500 ${analysisState.status !== 'idle' ? 'mt-0' : 'mt-4'}`}>
            ...
            <div className="flex flex-wrap lg:flex-nowrap gap-2 mt-6 justify-center px-2">
              ...
              <button
                ...
                className={`flex-1 min-w-[140px] flex flex-col md:flex-row items-center gap-3 p-3 rounded-lg border transition-all ${
              ...
              >
                ...
                <div className="text-center md:text-left">
                  ...
                  <div className="text-[10px] text-slate-500 hidden md:block truncate">{MODE_DESCRIPTIONS[lang][AnalysisMode.DEEP_DIVE]}</div>
                </div>
              </button>
              ...
              >
                ...
                <div className="text-center md:text-left">
                  ...
                  <div className="text-[10px] text-slate-500 hidden md:block truncate">{MODE_DESCRIPTIONS[lang][AnalysisMode.QUICK_INTEL]}</div>
                </div>
              </button>
            </div>
